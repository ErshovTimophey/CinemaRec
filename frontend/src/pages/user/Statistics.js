            ...
            try {
                ...
                const normalizedMovies = response.data.map(movie => {
                    const normalized = {
                        ...
                        posterPath: movie.posterUrl ? movie.posterUrl.replace(`http://localhost:8088/tmdb/movies/${movie.id}/poster`, '') : null,
                                    ...
                                    <img
                                        src={
                                            movieDetails.posterPath
                                                ? `http://localhost:8088/tmdb/movies/${movieDetails.id}/poster`
...
const MovieCard = ({ movie, email, onMarkAsWatched, onRemoveFromWatched, onClick }) => {
    ...
    const displayMovie = {
        ...
        posterPath: movie.posterPath || (movie.posterUrl?.replace(`http://localhost:8088/tmdb/movies/${movie.id}/poster`, '') || null),
